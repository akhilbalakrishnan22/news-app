 ...
 * It defines the Paging source for loading searched news articles from news API.
 */
...
/**
 * Paging source for loading searched news articles from the News API using the Paging 3 library.
 *
...
class SearchNewsPagingSource(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Article> {
        ...
        return try {
            // Fetch searched news articles from the News API
            val newsResponse =
